...
public class ItemController {
        ...
        public List<Item> list(@RequestParam(name = "name", required = false) String name,
                ...
                logger.info("Llamada a método ItemController::List()");
